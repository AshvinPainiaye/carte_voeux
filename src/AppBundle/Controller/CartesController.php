...
use AppBundle\Form\DestinaireType;
...
class CartesController extends Controller
{
    ...
    /**
     * Finds and displays a Cartes entity.
     *
     * @Route("/{id}", name="cartes_show")
     * @Method({"GET", "POST"})
     */
    public function showAction(Cartes $carte, Request $request)
    {
    ...
    /**
     * Displays a form to edit an existing Cartes entity.
     *
    ...
    /**
     * Creates a form to delete a Cartes entity.
     *
     * @param Cartes $carte The Cartes entity
     *
